...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0F1A] text-white px-4 sm:px-6 py-10">
      <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
        <div className="space-y-6">
          <div className="inline-flex items-center gap-2 text-xs uppercase tracking-[0.3em] text-indigo-300/80">
            Fantasy League
          </div>
        ...
        <div className="border border-white/10 bg-white/5 rounded-3xl p-6 sm:p-7 space-y-5 shadow-[0_0_50px_rgba(79,70,229,0.18)] backdrop-blur">
          <div className="space-y-1">
            <h2 className="text-2xl font-semibold">
              {mode === "signin" ? "Welcome back" : "Create account"}
            </h2>
            <p className="text-xs text-slate-300">
              Sign in to save your team and leagues.
            </p>
          </div>
